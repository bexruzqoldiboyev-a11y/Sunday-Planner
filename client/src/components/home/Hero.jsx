  ...
  return (
    <div className="glass ribbon">
      ...
      <div className="ribbon__head">
        <div>
          <div className="ribbon__title">Yakshanba · Toshkent</div>
          <div className="ribbon__budget">10:00 – 21:00 · doʻstlar bilan</div>
        </div>
        <span className="tag">namuna</span>
      </div>
      ...
      <motion.div className="ribbon__foot" layout>
        <span>Jami: {formatSum(plan.totals.spend)} soʻm</span>
        <span>Qoladi: {formatSum(plan.totals.remaining)} soʻm</span>
      </motion.div>
    </div>
  );
}
      ...
      <div className="shell shell--wide hero__grid">
        ...
        >
          ...
          <div className="stack" style={{ gap: '0.9rem' }}>
            <div className="chip-grid" role="group" aria-label="Namuna budjet">
            ...
            <Tilt strength={11} lift={8}>
              <DayRibbon budget={budget} />
            </Tilt>

            <p className="muted" style={{ fontSize: '0.8rem', margin: 0 }}>
              Budjetni bosib koʻring — reja shu yerda qayta tuziladi.
            </p>
          </div>
        </motion.div>
      </div>
