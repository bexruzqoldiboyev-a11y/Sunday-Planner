    ...
    <div className="stack" id="xarita" style={{ gap: '0.75rem' }}>
      {tiles === 'ok' ? (
        ...
        <div className="map map--loading">
          ...
          <span className="muted">Xarita yuklanmoqda…</span>
        </div>
      ) : (
      ...
      <div className="row" style={{ gap: '0.6rem', flexWrap: 'wrap' }}>
        ...
        <span className="muted" style={{ fontSize: '0.78rem' }}>
          {tiles === 'off'
            ? 'Xarita plitkalari ochilmadi — nuqtalar sxema koʻrinishida, koordinatalar real.'
            : 'Xarita: OpenStreetMap · joylar: Google Places'}
        </span>
      </div>
    </div>
  );
