...
/** Tez tanlash uchun: hafta kunlari (sana shu asosda hisoblanadi). */
export const QUICK_DAYS = [
  { id: 'today', key: 'f.today' },
  { id: 'tomorrow', key: 'f.tomorrow' },
  { id: 'saturday', key: 'day.saturday', weekday: 6 },
  { id: 'sunday', key: 'day.sunday', weekday: 0 },
];
...
export const DEFAULT_FORM = {
  // Sana boʻsh boʻlsa — eng yaqin yakshanba qoʻyiladi (PlanContext ichida)
  date: '',
  day: 'sunday',
  city: 'tashkent',
  cityLabel: 'Toshkent',
