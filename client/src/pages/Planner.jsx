    ...
    <section className="planner">
      <div className="shell shell--wide">
        ...
        >
          ...
          <p className="soft">
            Oltita qisqa savol. Javoblaringiz brauzerda saqlanadi — keyingi safar qayta yozmaysiz.
          </p>
        </motion.header>

        {status === 'error' && error?.details ? (
          <div className="glass" style={{ padding: 'var(--space-3)', marginBottom: 'var(--space-3)' }}>
            <ErrorState title="Maʼlumotlarni tekshiring" message={error.message} details={error.details} />
          </div>
        ) : null}
