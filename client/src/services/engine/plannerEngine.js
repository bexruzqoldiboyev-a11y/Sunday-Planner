/* ---------------------------------------------------------------------------
 * OFFLINE NUSXA. Bu fayl server/src/services/plannerEngine.js bilan bir xil.
 * Server ishlamay qolganda sayt "demo rejim"da ishlashi uchun brauzerda ham
 * shu generator ishlatiladi. Server tomonini oʻzgartirsangiz, shu nusxani ham
 * yangilang.
 * ------------------------------------------------------------------------- */
/**
