 ...
 */
export function PlaceArt({ category = 'default', seed = '', className = '', pad = false }) {
  ...
  // pad = sahna atrofida havo qoladi (katta bloklarda juda yaqin koʻrinmasin)
  const box = pad
    ? { x: -56, y: -32, w: 512, h: 289 }
    : { x: 0, y: 0, w: 400, h: 225 };
  ...
  return (
    ...
    >
      ...
      <rect x={box.x} y={box.y} width={box.w} height={box.h} fill={`url(#${id}-shade)`} />
    </svg>
  );
}
