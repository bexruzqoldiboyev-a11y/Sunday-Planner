...
export function Tilt({
  ...
  // Yassi «mozaika» uslubida burilish nozik boʻlishi kerak — shuning uchun
  // kelgan qiymat kamaytiriladi, asosiy javob esa koʻtarilish (lift) orqali.
  const soft = strength * 0.45;
  const rotateX = useSpring(useTransform(py, [0, 1], [soft, -soft]), SPRING);
  const rotateY = useSpring(useTransform(px, [0, 1], [-soft, soft]), SPRING);
